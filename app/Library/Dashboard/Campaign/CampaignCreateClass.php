...
/*
 * Campaign will be created using this class
 *
 * */
...
class CampaignCreateClass
{
    ...
    public function add_campaign($data)
    {
        ...
        $campaign->cpc = $this->prepare_cpc($data->cpc);
        $campaign->date = $date;
        $campaign->product_id = $data->product;
        $campaign->subproduct_id = $data->sub_product;
        if($today == $date){
        ...
        $this->result['cpc'] = $cpc;
        $this->result['url'] = $this->word_safe_break($campaign->url);
        $this->result['url_link'] = $campaign->url;
    }
    ...
    private function prepare_cpc($value)
    {
