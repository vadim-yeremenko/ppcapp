<div class="table table-box products-table products-table_style-1 margin-32px_top tabs">
    <div class="table-head">
        <div class="col">
            <div class="products-table_nav tabs-switcher">
                <a href="#" class="btn-link btn-ajax" data-url="{{route('admin-ajax')}}" data-ajax="show_products">Products</a>
                <span> / </span>
                <a href="#" class="btn-link btn-ajax active" data-url="{{route('admin-ajax')}}" data-ajax="show_users">Users</a>
            </div>
        </div>
        <div class="col">
            <div class="more-filters">
                ...
                <div class="filters-popup">
                    <form action="{{route('admin-ajax-filter')}}" data-action="filter_users_dashboard" data-redirect="1" class="filter-form" data-result="users_result_ajax">
    ...
    <div class="tabs-content-wrap">
        <div class="tabs-content" data-content="users">
            <div class="tabs-content_wrapper">
                <div id="users_result_ajax">
