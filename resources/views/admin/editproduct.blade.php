...
@section('content')
    <div id="content">
        <div class="dashboard-header mainbar-header margin-32px_bottom dashboard-header-back">
            <a href="#" onclick="history.back()"><span>Edit</span></a>
        </div>
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('add-product-form') }}">
                ...
                <div class="input-box">
                    <div class="input-box_l">
                        ...
                        <div class="input-box_input input-field-required">
                            <input type="text" class="input-field" placeholder="Please insert your name for product..." name="title" value="{{$product->name}}">
                            ...
                            <div class="input-box_input input-box_select">
                                <select name="parent_product" id="parent_product" class="select-styled" data-placeholder="Select sub product">
                                    @foreach ($products as $product)
                                        <option value="{{$product->id}}" @if($product->product_id = $product->id) selected @endif>{{$product->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><!--/.input-box_l-->
                    ...
                    <div class="input-box" id="cpc_range">
                        <div class="input-box_l input-box_flex">
                            <div class="col">
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="mincpc" placeholder="$0.00" value="{{$product->mincpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="maxcpc" placeholder="$0.00" value="{{$product->maxcpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                        </div><!--/.input-box_l-->
                    ...
                    <div class="input-box" id="cpc_singular">
                        <div class="input-box_l">
                            <div class="col">
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="singlecpc" placeholder="$0.00" value="{{$product->fixcpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                ...
                <div class="input-box">
                    <div class="input-box_l">
                        ...
                        <div class="input-box_input input-field-required">
                            <input type="text" class="input-field" placeholder="Please insert URL for product..." name="url" value="{{$product->url}}" required>
                            <span class="input-field-status"></span>
                        </div>
                    </div><!--/.input-box_l-->
                    <div class="input-box_r">
                                ...
                                <div class="input-box_input input-field-required account-avatar">
                                    ...
                                    <div class="img">
                                        @if(isset($product->image))
                                            <img src="{{$product->image}}" class="avatar-field-img">
                                        @else
