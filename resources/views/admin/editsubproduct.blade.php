...
@section('content')
    <div id="content">
        <div class="dashboard-header mainbar-header margin-32px_bottom dashboard-header-back">
            <a href="#" onclick="history.back()">Subproduct: <span>{{$subproduct->name}}</span></a>
        </div>
        <div class="mainbar-main">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('add-product-form') }}">
                ...
                <div class="input-box">
                    <div class="input-box_l">
                        ...
                        <div class="input-box_input input-field-required">
                            <input type="text" class="input-field" placeholder="Please insert your name for product..." name="title" value="{{$subproduct->name}}">
                ...
                <div class="input-box" >
                    <div class="input-box_l">
                        ...
                        <div class="input-box_input input-box_input-radio input-field-required">
                            <label for="subproduct-yes" class="subproducts-radio active">
                                <span>Yes</span>
                                <input type="radio" id="subproduct-yes" class="radio-btn" name="is_sub" value="yes" checked>
                            </label>
                            <label for="subproduct-no" class="subproducts-radio">
                                <span>No</span>
                                <input type="radio" id="subproduct-no" class="radio-btn" name="is_sub" value="no" >
                            </label>
                        </div>
                    </div><!--/.input-box_l-->
                    <div class="input-box_r">
                ...
                <div class="input-box input-box-sub">
                    <div class="input-box">
                        <div class="input-box_l">
                            <div class="input-box_title">
                ...
                <div class="input-box" >
                    ...
                    @else
                        <div class="input-box_l">
                            ...
                            <div class="input-box_input input-box_input-radio input-field-required">
                                <label for="cpc_type-singular" class="subproducts-radio bid-type-radio active">
                                    <span>Fixed</span>
                                    <input type="radio" id="cpc_type-singular" class="radio-btn" name="cpc_type" value="singular" checked>
                                </label>
                                <label for="cpc_type-range" class="subproducts-radio bid-type-radio ">
                                    <span>Range</span>
                                    <input type="radio" id="cpc_type-range" class="radio-btn" name="cpc_type" value="range">
                                </label>
                            </div>
                        </div><!--/.input-box_l-->
                    @endif
                    ...
                    <div class="input-box" id="cpc_range">
                        <div class="input-box_l input-box_flex">
                            <div class="col">
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="mincpc" placeholder="$0.00" value="{{$subproduct->mincpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="maxcpc" placeholder="$0.00" value="{{$subproduct->maxcpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                        </div><!--/.input-box_l-->
                ...
                @else
                    <div class="input-box" id="cpc_range" style="display: none;">
                        <div class="input-box_l input-box_flex">
                            <div class="col">
                                <div class="input-box_title">
                                    <span>Minimal CPC Bid</span>
                    ...
                    <div class="input-box" id="cpc_singular">
                        <div class="input-box_l">
                            <div class="col">
                                <div class="input-box_title">
                                    <span>Fixed CPC Bid</span>
                                ...
                                <div class="input-box_input input-field-required">
                                    <input type="text" class="input-field cpc-bid" name="singlecpc" placeholder="$0.00" value="{{$subproduct->fixcpc}}">
                                    <span class="input-field-status"></span>
                                </div>
                            </div>
                ...
                <div class="input-box">
                    <div class="input-box_l">
                        ...
                        <div class="input-box_input input-field-required">
                            <input type="text" class="input-field" placeholder="Please insert URL for product..." name="url" value="{{$subproduct->url}}" required>
                            <span class="input-field-status"></span>
                        </div>
                    </div><!--/.input-box_l-->
                    <div class="input-box_r">
                        ...
                        <div class="input-box_input input-field-required">
                            <div class="form-item left-label">
                                <div class="input-box_input input-field-required account-avatar">
                                    ...
                                    <div class="img">
                                        @if(isset($subproduct->image))
                                            <img src="{{$subproduct->image}}" class="avatar-field-img">
                                        @else
                                ...
                                <div class="input-box_btns btns-row">
                                    <a href="#" class="btn-edit choose-img-btn"><span>Change</span> <i class="icon-edit"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!--/.input-box_l-->
